...
const logger = LoggerFactory.get("MonitoringtempetureMainAbl");

class MonitoringtempetureMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["monitoringtempetureMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UunMonitoringtempeture",
        typeCode: "uun-monitoringtempeture-maing01",
        location: location,
